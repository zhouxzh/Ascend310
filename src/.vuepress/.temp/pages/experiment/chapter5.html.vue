<template><div><h1 id="ps定时器中断实验" tabindex="-1"><a class="header-anchor" href="#ps定时器中断实验"><span>PS定时器中断实验</span></a></h1>
<h3 id="实验概述" tabindex="-1"><a class="header-anchor" href="#实验概述"><span>实验概述</span></a></h3>
<ul>
<li><strong>实验 Vivado 工程名称</strong>: <code v-pre>ps_timer</code></li>
<li><strong>目标</strong>: 使用 ZYNQ 的 CPU Private Timer（私有定时器）实现定时器中断，每隔1秒触发一次中断，并在中断处理函数中打印信息，30秒后结束。</li>
</ul>
<h3 id="zynq-中断系统介绍" tabindex="-1"><a class="header-anchor" href="#zynq-中断系统介绍"><span>ZYNQ 中断系统介绍</span></a></h3>
<ul>
<li><strong>中断类型</strong>:
<ol>
<li><strong>SGI</strong> (软件生成中断): 16个端口</li>
<li><strong>PPI</strong> (CPU 私有外设中断): 5个</li>
<li><strong>SPI</strong> (共享外设中断): 44个来自PS端，16个来自PL端</li>
</ol>
</li>
<li><strong>中断控制器 (GIC)</strong>:
<ul>
<li><strong>ICC</strong>: 控制中断</li>
<li><strong>ICD</strong>: 连接SGI和PPI，配置SPI中断</li>
</ul>
</li>
</ul>
<h3 id="中断寄存器介绍" tabindex="-1"><a class="header-anchor" href="#中断寄存器介绍"><span>中断寄存器介绍</span></a></h3>
<ul>
<li><strong>ICDICFR</strong>: 配置触发方式，6个寄存器，每个32位，每两位表示一个中断</li>
<li><strong>ICDIPR</strong>: 中断优先级寄存器，24个寄存器，每8位代表一个中断</li>
<li><strong>ICDIPTR</strong>: CPU选择寄存器，24个寄存器，每8位代表一个中断</li>
<li><strong>ICDICER</strong>: 中断关闭寄存器，3个寄存器，每1位代表一个中断</li>
<li><strong>ICDISER</strong>: 中断使能寄存器，3个寄存器，每1位代表一个中断</li>
</ul>
<h3 id="sdk-程序编写步骤" tabindex="-1"><a class="header-anchor" href="#sdk-程序编写步骤"><span>SDK 程序编写步骤</span></a></h3>
<ol>
<li><strong>删除旧的硬件平台信息</strong>：在SDK中删除旧的硬件平台信息文件夹。</li>
<li><strong>重启SDK</strong>：在Vivado中重新运行SDK，生成新的硬件平台信息。</li>
<li><strong>创建新工程</strong>：在SDK中创建新工程，命名为<code v-pre>ps_timer_test</code>，模板为<code v-pre>Hello World</code>。</li>
<li><strong>编写代码</strong>：编写代码实现1秒定时器中断，并在中断处理函数中打印信息，30秒后结束。</li>
</ol>
<h3 id="代码示例" tabindex="-1"><a class="header-anchor" href="#代码示例"><span>代码示例</span></a></h3>
<p>以下是一个简单的Xilinx SDK代码示例，用于实现1秒定时器中断：</p>
...
<ul>
<li><strong>UG585</strong>: Zynq-7000 Technical Reference Manual</li>
</ul>
<h3 id="总结" tabindex="-1"><a class="header-anchor" href="#总结"><span>总结</span></a></h3>
<ul>
<li>本实验通过ZYNQ的私有定时器实现了1秒定时器中断，并在中断处理函数中打印信息，30秒后停止定时器。</li>
<li>代码中使用了Xilinx的API函数来控制定时器和中断控制器，开发者可以根据需求进一步修改和扩展。</li>
</ul>
</div></template>
