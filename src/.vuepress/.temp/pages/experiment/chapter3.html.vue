<template><div><h1 id="实验3-hmdi输出实验" tabindex="-1"><a class="header-anchor" href="#实验3-hmdi输出实验"><span>实验3：HMDI输出实验</span></a></h1>
<p><strong>实验 Vivado 工程：</strong> <code v-pre>hdmi_output_test</code><br>
<strong>责任角色：</strong> FPGA 工程师</p>
<h2 id="实验概述" tabindex="-1"><a class="header-anchor" href="#实验概述"><span>实验概述</span></a></h2>
<p>本章通过HDMI彩条输出实验，为后续视频处理奠定基础。实验不涉及PS系统，需掌握FPGA基础知识，重点关注以下要素：</p>
<ul>
<li><strong>像素时钟</strong>：分辨率相关的时序基准（本实验采用720p，74.25MHz）</li>
<li><strong>时序参数</strong>：行/场同步信号的有效长度、前后肩周期</li>
<li><strong>数据生成</strong>：RGB彩条数据的产生与编码</li>
</ul>
<blockquote>
<p><strong>实验特点</strong>：<br>
开发板直接使用FPGA的3.3V差分IO驱动HDMI接口，无需外置编码芯片。</p>
</blockquote>
<hr>
<h2 id="硬件设计" tabindex="-1"><a class="header-anchor" href="#硬件设计"><span>硬件设计</span></a></h2>
<h3 id="hdmi接口方案" tabindex="-1"><a class="header-anchor" href="#hdmi接口方案"><span>HDMI接口方案</span></a></h3>
<Mermaid id="mermaid-41" code=""></Mermaid><ul>
<li><strong>信号类型</strong>：TMDS差分信号（FPGA直接输出）</li>
<li><strong>分辨率支持</strong>：720p (1280x720@60Hz)</li>
...
<hr>
<h2 id="vivado工程搭建" tabindex="-1"><a class="header-anchor" href="#vivado工程搭建"><span>Vivado工程搭建</span></a></h2>
<h3 id="工程初始化" tabindex="-1"><a class="header-anchor" href="#工程初始化"><span>工程初始化</span></a></h3>
<ol>
<li>
<p><strong>新建工程</strong></p>
<ul>
<li>工程名：<code v-pre>hdmi_output_test</code></li>
<li>复制<code v-pre>repo</code>文件夹至工程目录（包含HDMI编码器IP）</li>
</ul>
</li>
<li>
<p><strong>添加第三方IP</strong></p>
<div class="language-操作步骤 line-numbers-mode" data-highlighter="shiki" data-ext="操作步骤" data-title="操作步骤" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>IP Catalog → Add Repository → 选择repo文件夹 → 确认添加</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><ul>
<li><strong>关键IP</strong>：<code v-pre>RGB to DVI Video Encoder</code>（Digilent提供）</li>
</ul>
</li>
</ol>
<hr>
<h3 id="ip核配置" tabindex="-1"><a class="header-anchor" href="#ip核配置"><span>IP核配置</span></a></h3>
<h4 id="hdmi编码器ip-rgb-to-dvi" tabindex="-1"><a class="header-anchor" href="#hdmi编码器ip-rgb-to-dvi"><span>HDMI编码器IP（RGB to DVI）</span></a></h4>
<ul>
<li><strong>IP名称</strong>：<code v-pre>rgb2dvi_0</code></li>
<li><strong>配置参数</strong>：
<ul>
<li>时钟源：内部生成（由像素时钟驱动）</li>
<li>TMDS时钟范围：<code v-pre>&lt;120 MHz</code>（720p模式）</li>
</ul>
</li>
</ul>
<h4 id="像素时钟生成模块-pll" tabindex="-1"><a class="header-anchor" href="#像素时钟生成模块-pll"><span>像素时钟生成模块（PLL）</span></a></h4>
<ul>
<li><strong>IP名称</strong>：<code v-pre>video_clock</code></li>
<li><strong>输入时钟</strong>：50MHz（开发板PL端晶振）</li>
<li><strong>输出时钟</strong>：
<ul>
<li><code v-pre>clk_out1</code>：74.25MHz（像素时钟）</li>
<li><code v-pre>clk_out2</code>：371.25MHz（5倍频，用于TMDS串行化）</li>
</ul>
</li>
</ul>
<hr>
<h3 id="彩条生成模块" tabindex="-1"><a class="header-anchor" href="#彩条生成模块"><span>彩条生成模块</span></a></h3>
<h4 id="模块功能" tabindex="-1"><a class="header-anchor" href="#模块功能"><span>模块功能</span></a></h4>
<ul>
<li>产生720p时序信号（HS/VS/DE）</li>
<li>生成水平方向8色渐变彩条（RGB 24-bit）</li>
</ul>
<h4 id="代码核心逻辑" tabindex="-1"><a class="header-anchor" href="#代码核心逻辑"><span>代码核心逻辑</span></a></h4>
...
<h3 id="顶层模块设计" tabindex="-1"><a class="header-anchor" href="#顶层模块设计"><span>顶层模块设计</span></a></h3>
<h4 id="模块结构" tabindex="-1"><a class="header-anchor" href="#模块结构"><span>模块结构</span></a></h4>
...
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD">endmodule</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr>
<h2 id="关键实现步骤" tabindex="-1"><a class="header-anchor" href="#关键实现步骤"><span>关键实现步骤</span></a></h2>
<ol>
<li>
<p><strong>IP核生成</strong></p>
<ul>
<li>通过IP Catalog添加并配置<code v-pre>rgb2dvi_0</code>和<code v-pre>video_clock</code>模块。</li>
</ul>
</li>
<li>
<p><strong>代码集成</strong></p>
<ul>
<li>将彩条生成模块<code v-pre>color_bar.v</code>加入工程，并连接至顶层模块。</li>
</ul>
</li>
<li>
<p><strong>约束文件配置</strong></p>
<ul>
<li>指定HDMI接口引脚位置与电平标准（LVDS_33）。</li>
</ul>
</li>
<li>
<p><strong>综合与实现</strong></p>
<ul>
<li>运行全流程编译，检查时序收敛性。</li>
</ul>
</li>
</ol>
<hr>
...
<ol>
<li>
<p><strong>时钟精度</strong></p>
<ul>
<li>确保像素时钟误差在±1%以内，避免显示抖动。</li>
</ul>
</li>
<li>
<p><strong>差分信号约束</strong></p>
<ul>
<li>需在XDC文件中声明TMDS信号的差分对属性。</li>
</ul>
</li>
<li>
<p><strong>复位逻辑</strong></p>
<ul>
<li>编码器IP的复位信号需与像素时钟同步。</li>
</ul>
</li>
</ol>
<hr>
<blockquote>
<p><strong>扩展学习</strong>：<br>
可通过修改<code v-pre>color_bar</code>模块的时序参数，适配其他分辨率（如1080p），需同步调整像素时钟与编码器配置。</p>
</blockquote>
</div></template>
