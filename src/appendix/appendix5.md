...
## 模型转换参数模板合集 {#src-book-appendix-h3}

### 分类模型 (ResNet) {#src-book-appendix-h4}
...
### YOLO 动态分辨率 {#src-book-appendix-h5}
...
### INT8 量化（示例） {#src-book-appendix-h6}
...
## 性能与质量 Checklist（执行勾项） {#src-book-appendix-h7}
...
## 推荐资源与外部引用 {#src-book-appendix-h9}
