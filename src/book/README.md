...
| Chapter 9 | AI项目交付闭环 | SSD300实验室实时检测、评测体系、标准化交付流程 | 建立规范的AI项目交付方法论 |
### 实践案例 {#src-book-README-h5}

包含从 **Case 1** 到 **Case 9** 的九个端侧 AI 实战案例，涵盖人脸打卡机、实时跟踪、智能电子琴、掌纹识别、数据采集仪、智能小车、智能相册、手势识别与聊天机器人。

### 附录

附录用于集中收录实验基础和查阅型资料。附录 1 介绍开发板与基础环境，附录 2 提供基于昇腾 310B 的 Ubuntu 教程，附录 3 介绍 Python 编程基础，附录 4 介绍 Vibe Coding 基础，附录 5 汇集工具箱、FAQ 与参数模板，附录 6 提供 ROS2 基础教程。
...
- **附录 3**：Python 编程基础
- **附录 4**：Vibe Coding 基础
- **附录 5**：常见报错速查、模型转换参数模板、性能与质量 Checklist、术语表与 FAQ
- **附录 6**：ROS2 基础教程，涵盖 DDS、工作空间、通信、launch、TF2/URDF、多机通信与自启动
...
| 读者类型 | 推荐阅读路径 | 目标 | 补充建议 |
| :-- | :-- | :-- | :-- |
| 零基础学生 | 附录 1、Chapter 1、Chapter 2、Case 1 | 能跑通首个模型 | 结合案例做改动实验 |
