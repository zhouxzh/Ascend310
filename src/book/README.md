...
附录用于集中收录实验基础和查阅型资料。附录 1 介绍开发板与基础环境，附录 2 系统整理昇腾 310B Linux 操作与命令，附录 3 汇集工具箱、FAQ 与参数模板；后续附录按阿拉伯数字顺序扩展。
...
- **附录 2**：昇腾 310B Linux shell、CANN、设备、服务、测试与证据边界
- **附录 3**：常见报错速查、模型转换参数模板、性能与质量 Checklist、术语表与 FAQ
