...
## A.3 模型转换参数模板合集 {#src-book-appendix-h3}

### A.3.1 分类模型 (ResNet) {#src-book-appendix-h4}
...
### A.3.2 YOLO 动态分辨率 {#src-book-appendix-h5}
...
### A.3.3 INT8 量化（示例） {#src-book-appendix-h6}
...
## A.4 性能与质量 Checklist（执行勾项） {#src-book-appendix-h7}
...
## A.5 术语表（扩展） {#src-book-appendix-h8}
...
## A.6 推荐资源与外部引用 {#src-book-appendix-h9}
...
## A.7 贡献指南摘要 {#src-book-appendix-h10}
...
## A.11 实践任务 {#src-book-appendix-h14}
