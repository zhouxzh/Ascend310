...
## CANN异构计算架构 {#src-book-chapter2-h1}
...
### CANN异构计算与人工智能 {#src-book-chapter2-h2}
...
### CANN与CUDA {#src-book-chapter2-h3}
...
![CANN逻辑图](img2/CANN_logic.png){#fig:cann_logic width=90% .center}
...
### CANN的快速安装 {#src-book-chapter2-h5}
...
#### 安装命令与依赖说明 {#src-book-chapter2-h7}
...
## ATC模型转换详解 {#src-book-chapter2-h8}

### ATC工具介绍 {#src-book-chapter2-h9}
...
![ATC框架图](img2/atc.png){#fig:atc width=70% .center}
...
#### onnx格式介绍 {#src-book-chapter2-h10}
...
### ATC工具使用流程 {#src-book-chapter2-h11}

使用ATC工具进行模型转换的使用流程如下图所示：

![ATC流程图](img2/atc_flow.png){#fig:atc_flow width=40% .center}
...
####  模型转换-以ResNet50为例 {#src-book-chapter2-h12}
...
### 模型推理工具msame工具概览 {#src-book-chapter2-h14}
...
#### msame工具的获取与构建 {#src-book-chapter2-h15}
...
4. 运行构建脚本生成可执行文件：
  ```bash
  # 若脚本缺少执行权限，请先执行 chmod +x build.sh
  ./build.sh g++
  ```
...
![resnet测试图片](img2/dog1_1024_683.jpg){#fig:dog width=50% .center}
