...
class SdrControls(QWidget):
    ...
    def __init__(self, parent=None) -> None:
        ...
        self.model_info.setObjectName("sdrModelInfo")
        ...
        self.capture_estimate.setObjectName("sdrCaptureEstimate")
        ...
        self.availability_label.setObjectName("sdrAvailabilityLabel")
