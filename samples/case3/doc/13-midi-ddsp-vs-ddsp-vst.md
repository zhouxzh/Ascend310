...
> 麦克风 Effect。当前操作请以[WebUI 操作、部署与 API](02-webui.md)为准。
...
- [模型与 OM 部署](03-om-deployment.md)
- [MIDI-DDSP 历史导出](12-midi-ddsp-export.md)
- [实时 DDSP](14-realtime-ddsp.md)
- [MIDI-DDSP OM 实时 MIDI 合成测试](05-midi-ddsp-realtime.md)
- [OM 转换与验证](03-om-deployment.md)
- [Upstream 参考仓库清单](15-upstream-repositories.md)
