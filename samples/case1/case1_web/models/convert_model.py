...
# ======================================================================================
# MobileFaceNet Class Definition
# Source: https://github.com/foamliu/MobileFaceNet/blob/master/mobilefacenet.py
# ======================================================================================
...
def convert_pt_to_onnx(pt_model_path: str, onnx_model_path: str):
    """
    Converts a PyTorch MobileFaceNet model to ONNX format.

    Args:
        pt_model_path: Path to the input .pt model file.
        onnx_model_path: Path to save the output .onnx model file.
    """
...
if __name__ == "__main__":
    # Define file paths
    pt_file = os.path.join("models", "mobilefacenet.pt")
    onnx_file = os.path.join("models", "mobilefacenet.onnx")

    # Check if the .pt file exists
    if not os.path.exists(pt_file):
        print(f"Error: PyTorch model file not found at '{pt_file}'")
        print("Please run 'python download_mobilefacenet.py' first.")
    else:
        # Run the conversion
