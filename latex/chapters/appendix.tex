\section{A.1 附录总览}\label{src-book-appendix-h1}

本附录聚焦``查得快、用得稳''：常见报错速查、转换参数模板、性能/质量
Checklist、术语字典、推荐资源与社区贡献规范。可作为日常开发随手翻阅的工具章节。

\section{A.2 常见报错速查}\label{src-book-appendix-h2}
...
\section{A.3 模型转换参数模板合集}\label{src-book-appendix-h3}

\subsection{A.3.1 分类模型 (ResNet)}\label{src-book-appendix-h4}
...
\subsection{A.3.2 YOLO 动态分辨率}\label{src-book-appendix-h5}
...
\subsection{A.3.3 INT8 量化（示例）}\label{src-book-appendix-h6}
...
\section{A.4 性能与质量
Checklist（执行勾项）}\label{src-book-appendix-h7}
...
\section{A.5 术语表（扩展）}\label{src-book-appendix-h8}
...
\section{A.6 推荐资源与外部引用}\label{src-book-appendix-h9}
...
\section{A.7 贡献指南摘要}\label{src-book-appendix-h10}
...
\section{A.8 FAQ}\label{src-book-appendix-h11}
...
\section{A.9 License 与引用}\label{src-book-appendix-h12}

本书内容遵循 Apache 2.0 许可证。引用： \textgreater{}
《昇腾310B实战：从入门到精通边缘计算与人工智能》（GitHub:
zhouxzh/Ascend310）

\section{A.10 版本路线回顾}\label{src-book-appendix-h13}
...
\section{A.11 实践任务}\label{src-book-appendix-h14}
