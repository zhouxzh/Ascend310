\section{章节总览}\label{src-book-chapter8-h1}
...
\section{需求澄清 Canvas}\label{src-book-chapter8-h2}
...
\section{指标分层与优先级}\label{src-book-chapter8-h3}
...
\section{Baseline 策略与控制变量法}\label{src-book-chapter8-h4}
...
\section{评测集设计原则}\label{src-book-chapter8-h5}
...
\section{迭代计划与看板}\label{src-book-chapter8-h6}
...
\section{资产沉淀文档体系}\label{src-book-chapter8-h7}
...
\section{交付目录与不可变产物}\label{src-book-chapter8-h8}
...
\section{上线前综合 Checklist}\label{src-book-chapter8-h9}
...
\section{验收、回归与漂移监测}\label{src-book-chapter8-h10}
...
\section{风险管理与决策日志}\label{src-book-chapter8-h11}
...
\section{章节小结}\label{src-book-chapter8-h12}

方法论的核心不是流程文档堆砌，而是``指标驱动 + 资产沉淀 +
可回滚''三支柱。通过契约化需求、标准化
Baseline、规范化评测与回归体系，使团队协作更高效、风险暴露更透明、交付结果更可信。

\section{实践任务}\label{src-book-chapter8-h13}
