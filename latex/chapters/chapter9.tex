...
\section{常见报错速查}\label{src-book-chapter9-h2}
...
\section{模型转换参数模板合集}\label{src-book-chapter9-h3}

\subsection{分类模型 (ResNet)}\label{src-book-chapter9-h4}
...
\subsection{YOLO 动态分辨率}\label{src-book-chapter9-h5}
...
\subsection{INT8 量化（示例）}\label{src-book-chapter9-h6}
...
\section{性能与质量 Checklist（执行勾项）}\label{src-book-chapter9-h7}
...
\section{术语表（扩展）}\label{src-book-chapter9-h8}
...
\section{推荐资源与外部引用}\label{src-book-chapter9-h9}
...
\section{贡献指南摘要}\label{src-book-chapter9-h10}
...
\section{FAQ}\label{src-book-chapter9-h11}
...
\section{License 与引用}\label{src-book-chapter9-h12}

本书内容遵循 Apache 2.0 许可证。引用： \textgreater{}
《昇腾310B实战：从入门到精通边缘计算与人工智能》（GitHub:
zhouxzh/Ascend310）

\section{版本路线回顾}\label{src-book-chapter9-h13}
...
\section{实践任务}\label{src-book-chapter9-h14}
