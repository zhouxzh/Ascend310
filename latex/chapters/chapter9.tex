\section{9.1 章节总览}\label{src-book-chapter9-h1}

本章建立从需求澄清-\textgreater 指标体系-\textgreater 评测集-\textgreater 迭代节奏-\textgreater 资产沉淀-\textgreater 交付与回归的一套闭环方法论，让技术决策基于指标与风险敞口，而非经验臆测。核心理念：可量化、可比较、可复用、可追溯。

\section{9.2 需求澄清 Canvas}\label{src-book-chapter9-h2}
...
\section{9.3 指标分层与优先级}\label{src-book-chapter9-h3}
...
\section{9.4 Baseline 策略与控制变量法}\label{src-book-chapter9-h4}
...
\section{9.5 评测集设计原则}\label{src-book-chapter9-h5}
...
\section{9.6 迭代计划与看板}\label{src-book-chapter9-h6}
...
\section{9.7 资产沉淀文档体系}\label{src-book-chapter9-h7}
...
\section{9.8 交付目录与不可变产物}\label{src-book-chapter9-h8}
...
\section{9.9 上线前综合 Checklist}\label{src-book-chapter9-h9}
...
\section{9.10 验收、回归与漂移监测}\label{src-book-chapter9-h10}
...
\section{9.11 风险管理与决策日志}\label{src-book-chapter9-h11}
...
\section{9.12 章节小结}\label{src-book-chapter9-h12}

方法论的核心不是流程文档堆砌，而是``指标驱动 + 资产沉淀 +
可回滚''三支柱。通过契约化需求、标准化
Baseline、规范化评测与回归体系，使团队协作更高效、风险暴露更透明、交付结果更可信。

\section{9.13 实践任务}\label{src-book-chapter9-h13}
