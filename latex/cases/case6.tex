...
\subsection{2.3.
计算机视觉系统}\label{23-ux8ba1ux7b97ux673aux89c6ux89c9ux7cfbux7edf}
...
\subsection{2.4.
路径规划与导航}\label{24-ux8defux5f84ux89c4ux5212ux4e0eux5bfcux822a}
...
\subsection{2.5.
运动控制系统}\label{25-ux8fd0ux52a8ux63a7ux5236ux7cfbux7edf}
...
\subsection{2.6. AI决策系统}\label{26-aiux51b3ux7b56ux7cfbux7edf}
...
\subsection{2.8. 安全系统}\label{28-ux5b89ux5168ux7cfbux7edf}
...
\subsection{2.9.
3D打印结构件}\label{29-3dux6253ux5370ux7ed3ux6784ux4ef6}
...
\tightlist
\item
  \textbf{材料}: PLA (原型) 或 ABS (实用)
\item
  \textbf{层高}: 0.2mm
\item
  \textbf{填充率}: 25\% (结构件) / 15\% (外壳)
\end{itemize}

\subsection{2.10. 用户手册}\label{210-ux7528ux6237ux624bux518c}

\subsubsection{2.10.1 硬件组装}\label{2101-ux786cux4ef6ux7ec4ux88c5}
...
\subsubsection{2.10.2 软件配置}\label{2102-ux8f6fux4ef6ux914dux7f6e}
...
\subsubsection{2.10.3 操作指南}\label{2103-ux64cdux4f5cux6307ux5357}
...
\subsubsection{2.10.4 维护保养}\label{2104-ux7ef4ux62a4ux4fddux517b}
