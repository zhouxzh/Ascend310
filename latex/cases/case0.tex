...
\item
  ...
  \passthrough{\lstinline!powershell  certutil -hashfile opiaipro\_ubuntu22.04\_desktop\_aarch64\_20241128.img.xz md5!}
  将输出的 MD5 与
  ...
  \end{figure}
\item
  \textbf{Ubuntu}： \passthrough{\lstinline!bash  md5sum <filename>!}
\item
  \textbf{macOS}： \passthrough{\lstinline!bash  md5 <filename>!}
\end{itemize}
