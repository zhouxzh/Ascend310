...
\subsection{2.3.
掌纹图像预处理}\label{23-ux638cux7eb9ux56feux50cfux9884ux5904ux7406}
...
\subsection{2.4.
特征提取与匹配}\label{24-ux7279ux5f81ux63d0ux53d6ux4e0eux5339ux914d}
...
\subsection{2.6.
系统部署与集成}\label{26-ux7cfbux7edfux90e8ux7f72ux4e0eux96c6ux6210}
...
\subsection{2.7.
3D打印结构件}\label{27-3dux6253ux5370ux7ed3ux6784ux4ef6}
...
\tightlist
\item
  \textbf{材料}: PETG (化学稳定性好)
\item
  \textbf{层高}: 0.15mm (精细结构)
\item
  \textbf{填充率}: 40\% (强度要求)
\end{itemize}

\subsection{2.8. 用户手册}\label{28-ux7528ux6237ux624bux518c}

\subsubsection{2.8.1 系统部署}\label{281-ux7cfbux7edfux90e8ux7f72}
...
\subsubsection{2.8.2
用户注册流程}\label{282-ux7528ux6237ux6ce8ux518cux6d41ux7a0b}
...
\subsubsection{2.8.3
身份验证流程}\label{283-ux8eabux4efdux9a8cux8bc1ux6d41ux7a0b}
...
\subsubsection{2.8.4 系统维护}\label{284-ux7cfbux7edfux7ef4ux62a4}
