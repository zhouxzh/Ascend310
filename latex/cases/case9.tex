...
\subsubsection{2.3.1
为什么不在NPU上直接跑LLM}\label{ux4e3aux4ec0ux4e48ux4e0dux5728npuux4e0aux76f4ux63a5ux8dd1llm}
...
\subsubsection{2.3.2
三层架构设计}\label{ux4e09ux5c42ux67b6ux6784ux8bbeux8ba1}
...
\subsubsection{2.3.3
与纯云端/纯边缘方案的对比}\label{ux4e0eux7eafux4e91ux7aefux7eafux8fb9ux7f18ux65b9ux6848ux7684ux5bf9ux6bd4}
...
\subsection{2.4.
文本嵌入模型与昇腾部署}\label{ux6587ux672cux5d4cux5165ux6a21ux578bux4e0eux6607ux817eux90e8ux7f72}

本节详细介绍如何在昇腾310B上部署文本嵌入模型，这是整个RAG管道的基石。

\subsubsection{2.4.1
什么是文本嵌入}\label{ux4ec0ux4e48ux662fux6587ux672cux5d4cux5165}
...
all-MiniLM-L6-v2}\label{ux4e3aux4ec0ux4e48ux9009ux62e9-all-minilm-l6-v2}
...
\subsubsection{2.4.3
模型转换管线}\label{ux6a21ux578bux8f6cux6362ux7ba1ux7ebf}
...
\subsubsection{2.4.4 NPU 推理封装}\label{npu-ux63a8ux7406ux5c01ux88c5}
...
\subsection{2.5.
知识库与向量检索}\label{ux77e5ux8bc6ux5e93ux4e0eux5411ux91cfux68c0ux7d22}

有了嵌入模型，下一步是构建知识库并实现高效的向量检索。

\subsubsection{2.5.1 RAG
的核心思想}\label{rag-ux7684ux6838ux5fc3ux601dux60f3}
...
\subsubsection{2.5.2
中文文本分块策略}\label{ux4e2dux6587ux6587ux672cux5206ux5757ux7b56ux7565}
...
\subsubsection{2.5.3 FAISS
向量索引}\label{faiss-ux5411ux91cfux7d22ux5f15}
...
\subsubsection{2.5.4 知识库管理}\label{ux77e5ux8bc6ux5e93ux7ba1ux7406}
...
\subsection{2.6.
对话管理与响应生成}\label{ux5bf9ux8bddux7ba1ux7406ux4e0eux54cdux5e94ux751fux6210}

\subsubsection{2.6.1 对话状态机}\label{ux5bf9ux8bddux72b6ux6001ux673a}
...
\subsubsection{2.6.2
两级回复生成}\label{ux4e24ux7ea7ux56deux590dux751fux6210}
...
\subsubsection{2.6.3
对话历史管理}\label{ux5bf9ux8bddux5386ux53f2ux7ba1ux7406}
...
\subsubsection{2.7.1 语音识别}\label{ux8bedux97f3ux8bc6ux522b}
...
\subsubsection{2.7.2 语音合成}\label{ux8bedux97f3ux5408ux6210}
...
\subsubsection{2.7.3
浏览器端录音}\label{ux6d4fux89c8ux5668ux7aefux5f55ux97f3}
...
\subsubsection{2.8.1 界面设计}\label{ux754cux9762ux8bbeux8ba1}
...
\subsubsection{2.8.2 事件流}\label{ux4e8bux4ef6ux6d41}
...
\subsubsection{2.9.2 配置说明}\label{ux914dux7f6eux8bf4ux660e}
...
\item
  \textbf{语音输入}：点击 🎤 按钮开始录音，再次点击停止，自动识别并发送
\item
...
\subsubsection{2.9.4 维护与扩展}\label{ux7ef4ux62a4ux4e0eux6269ux5c55}
...
\subsection{基础对话 ---
离线模板模式}\label{ux57faux7840ux5bf9ux8bdd-ux79bbux7ebfux6a21ux677fux6a21ux5f0f}
...
\subsection{RAG 检索 ---
专业问题}\label{rag-ux68c0ux7d22-ux4e13ux4e1aux95eeux9898}
...
\subsection{语音交互}\label{ux8bedux97f3ux4ea4ux4e92}
