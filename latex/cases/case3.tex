...
\subsection{硬件准备}\label{src-experiment-case3-h3}
...
\subsection{软件环境}\label{src-experiment-case3-h4}
...
\subsection{手势识别与音符映射}\label{src-experiment-case3-h5}
...
\subsection{模型训练与优化}\label{src-experiment-case3-h6}
...
\subsection{音频合成与处理}\label{src-experiment-case3-h7}
...
\subsection{3D打印结构件}\label{src-experiment-case3-h8}
...
\subsection{用户手册}\label{src-experiment-case3-h9}

\subsubsection{快速上手}\label{src-experiment-case3-h10}
...
\subsubsection{演奏模式}\label{src-experiment-case3-h11}
...
\subsubsection{高级功能}\label{src-experiment-case3-h12}
...
\subsubsection{故障排除}\label{src-experiment-case3-h13}
