...
\section{1. 项目简介}\label{src-experiment-case3-h1}
...
\section{2. 内容大纲}\label{src-experiment-case3-h2}

\subsection{2.1. 硬件准备}\label{src-experiment-case3-h3}
...
\subsection{2.2. 软件环境}\label{src-experiment-case3-h4}
...
\subsection{2.3. 手势识别与音符映射}\label{src-experiment-case3-h5}
...
\subsection{2.4. 模型训练与优化}\label{src-experiment-case3-h6}
...
\subsection{2.5. 音频合成与处理}\label{src-experiment-case3-h7}
...
\subsection{2.6. 3D打印结构件}\label{src-experiment-case3-h8}
...
\subsection{2.7. 用户手册}\label{src-experiment-case3-h9}

\subsubsection{2.7.1 快速上手}\label{src-experiment-case3-h10}
...
\subsubsection{2.7.2 演奏模式}\label{src-experiment-case3-h11}
...
\subsubsection{2.7.3 高级功能}\label{src-experiment-case3-h12}
...
\subsubsection{2.7.4 故障排除}\label{src-experiment-case3-h13}
...
\section{3. 源代码结构}\label{src-experiment-case3-h14}
...
\section{4. 效果演示}\label{src-experiment-case3-h15}
