...
项目的源代码可以从\href{https://github.com/zhouxzh/Ascend310/tree/main/samples/case3}{这里}下载。
...
\subsection{2.3.
手势识别与音符映射}\label{23-ux624bux52bfux8bc6ux522bux4e0eux97f3ux7b26ux6620ux5c04}
...
\subsection{2.4.
模型训练与优化}\label{24-ux6a21ux578bux8badux7ec3ux4e0eux4f18ux5316}
...
\subsection{2.5.
音频合成与处理}\label{25-ux97f3ux9891ux5408ux6210ux4e0eux5904ux7406}
...
\subsection{2.6.
3D打印结构件}\label{26-3dux6253ux5370ux7ed3ux6784ux4ef6}
...
\tightlist
\item
  \textbf{材料选择}: ABS (强度好，适合结构件)
\item
  \textbf{层高设置}: 0.2mm
\item
  \textbf{填充密度}: 25\%
\item
  \textbf{支撑设置}: 针对悬垂结构添加支撑
\end{itemize}

\subsection{2.7. 用户手册}\label{27-ux7528ux6237ux624bux518c}

\subsubsection{2.7.1 快速上手}\label{271-ux5febux901fux4e0aux624b}
...
\subsubsection{2.7.2 演奏模式}\label{272-ux6f14ux594fux6a21ux5f0f}
...
\subsubsection{2.7.3 高级功能}\label{273-ux9ad8ux7ea7ux529fux80fd}
...
\subsubsection{2.7.4 故障排除}\label{274-ux6545ux969cux6392ux9664}
