...
% 设置开源中文字体（在 Windows 上常见名称），并提供回退
...
% 可选：定义 \kai 和 \hei 命令以匹配你文档中的用法
\IfFontExistsTF{XiaowuWenkai-Regular}{
  \newCJKfontfamily\kaifont{XiaowuWenkai-Regular}
  \newcommand{\kai}{\kaifont}
}{
  \newCJKfontfamily\kaifont{KaiTi}
  \newcommand{\kai}{\kaifont}
}
\newCJKfontfamily\heifont{SimHei}
\newcommand{\hei}{\heifont}
