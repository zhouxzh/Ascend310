...
pandoc ../src/experiment/case0.md --top-level-division=chapter --syntax-highlighting=idiomatic -t latex --extract-media=cases/media --resource-path=../src/experiment --include-in-header=d:/Github/Ascend310/latex/pandoc-header.tex -o cases/case0.tex